...
<div class="cart">
    ...
    <input type="text" id="nama" name="nama" class="form-barang" value="<?= $_SESSION['username'] ?>" readonly><br><br>

    <label for="nama_barang">Nama Barang</label>
    <input type="text" id="nama_barang" name="nama_barang" class="form-barang" value="<?= $nama_barang?>" readonly><br></br>

    <label for="tanggal">Tanggal Transaksi</label>
    <input type="date" id="tanggal" name="tanggal" class="form-barang"><br><br>

    <label for="jumlah_barang">Jumlah Barang</label>
    <input type="number" min="1" id="jumlah_barang" name="jumlah_barang" value="1" class="form-barang"><br><br>
